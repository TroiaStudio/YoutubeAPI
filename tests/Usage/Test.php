...
//dump($playList);
//dump($playList->serialize());

//dump($playList->toArray());
//dump(\Symfony\Component\Yaml\Yaml::dump($playList->toArray(), 1));

//file_put_contents('test.yaml', \Symfony\Component\Yaml\Yaml::dump($playList->toArray(), 10));
